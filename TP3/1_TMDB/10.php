<?php
	...
	# On récupère les liens des trailers (en demandant à l'API movie/videos) que l'on met dans un tableau
	$video_keys = [];
	foreach ($movies_data as $movie) {
		$video_data = json_decode(smartcurl("https://api.themoviedb.org/3/movie/" . $movie["id"] . "/videos?api_key=ebb02613ce5a2ae58fde00f4db95a9c1&language=fr")[0], true)["results"];
		$video_keys[] = count($video_data) == 0 ? "" : $video_data[0]["key"];
	}
			...
			<tr>
				...
				<?php
					foreach ($video_keys as $key) {
						echo "<td>\n";
						if ($key != "") {
							echo "<iframe src=\"https://www.youtube.com/embed/" . $key . "\" allowfullscreen=\"allowfullscreen\" mozallowfullscreen=\"mozallowfullscreen\" msallowfullscreen=\"msallowfullscreen\" oallowfullscreen=\"oallowfullscreen\" webkitallowfullscreen=\"webkitallowfullscreen\"></iframe>\n";
						}
						echo "</td>\n";
					}
				?>
